...
function generateFakeDailyScores(string $month, int $baseScore): array
{
    ...
    for ($day = 1; $day <= $numberOfDays; $day++) {
        $currentDate = new DateTime($month . '-' . str_pad($day, 2, '0', STR_PAD_LEFT));
    ...
    <?php else : ?>
        ...
        <section class="explore-layout">
            ...
            <aside class="recommendations-panel">
                ...
                <div class="recommendations-list">
                    ...
                    foreach($recommendations as $key => $recommendation){
                        ...
                        <article class="recommendations-item <?= $key === 0 ? 'active' : ''?>" data-index="<?= $key ?>">
            ...
            <section class="explore-details">
                ...
                >
                    <div>
                        <h2 id="topRecommendationName"><?= htmlspecialchars($top1Recommendation['name']) ?></h2>
                        <p id="topRecommendationRegion"><?= htmlspecialchars($top1Recommendation['region']) ?>, France</p>
                    </div>
                ...
                <section class="info-grid">
                    <article class="info-card">
                        <h3>
                            ...
                            <span id="topMonth"><?= htmlspecialchars($top1Recommendation['month']) ?></span> Moyennes
                        </h3>
                        
                        <div class="weather-stats">
                            <div>
                                <strong>
                                    <span id="topAverageTemp"><?= htmlspecialchars($top1Recommendation['averageTemp']) ?></span>
                                </strong>
                                <span>Temp</span>
                            </div>
                            ...
                            <div>
                                <strong>
                                    <span id="topPrecipitation"><?= htmlspecialchars($top1Recommendation['precipitation']) ?></span>
                                    <small>mm</small>
                                </strong>
                                <span>Prec</span>
                            </div>
                            ...
                            <div>
                                <strong >
                                    <span id="topSunHours"><?= htmlspecialchars($top1Recommendation['sunHours']) ?></span>
                                    <small>h</small>
                                </strong>
                                <span>Soleil</span>
                            </div>
                ...
                <section class="travel-score">
                    <div class="travel-score-header">
                        <div>
                            ...
                            <p>
                                Durée sélectionnée :
                                <strong><?= htmlspecialchars($duration) ?> jour<?= $duration > 1 ? 's' : '' ?></strong>
                            </p>
                        </div>
                ...
                <form method="POST" action="<?= url('pages/book-event.php') ?>" class="booking-form">
